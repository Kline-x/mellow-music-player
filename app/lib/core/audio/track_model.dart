...
final List<Track> mockPresetTracks = [
  ...
  Track(
    ...
    artist: '买辣椒也用券',
    album: '起风了',
    coverUrl: 'https://p2.music.126.net/diGAyEmpymX8G7JcnElncQ==/109951163699673355.jpg?param=300y300',
...
final List<ArtistProfile> mockArtistsProfiles = [
  ArtistProfile(
    ...
    avatarUrl: 'https://p3.music.126.net/OIWgfWdEaYcE4otKUnFQiw==/109951168978186672.jpg?param=300y300',
    musicSize: 62,
    albumSize: 18,
  ...
  ArtistProfile(
    ...
    avatarUrl: 'https://p4.music.126.net/_ECPuM0s0qtWhkpQOSTZUg==/109951169164936940.jpg?param=300y300',
    musicSize: 128,
    albumSize: 45,
  ...
  ArtistProfile(
    ...
    avatarUrl: 'https://p3.music.126.net/9aCJYVD0JZ0NckqAn3a_3w==/109951165566993818.jpg?param=300y300',
    musicSize: 95,
    albumSize: 22,
  ...
  ArtistProfile(
    ...
    avatarUrl: 'https://p3.music.126.net/4BKx-aKdF5nP5y6usQoN8w==/109951167739264488.jpg?param=300y300',
    musicSize: 45,
    albumSize: 8,
  ...
  ArtistProfile(
    ...
    avatarUrl: 'https://p4.music.126.net/jj0EasWfUZpf1LW2SFeN-A==/109951173289562420.jpg?param=300y300',
    musicSize: 310,
    albumSize: 68,
    tracks: const [],
  ),
  ArtistProfile(
    ...
    avatarUrl: 'https://p4.music.126.net/r6W-zCnV-aduVn_PLZYuYg==/109951168529049969.jpg?param=300y300',
    musicSize: 240,
    albumSize: 52,
    tracks: const [],
  ),
  ArtistProfile(
    ...
    avatarUrl: 'https://p4.music.126.net/4egsgJXURoPcBNjj00YQHQ==/109951170045684137.jpg?param=300y300',
    musicSize: 180,
    albumSize: 36,
    tracks: const [],
  ),
  ArtistProfile(
    ...
    avatarUrl: 'https://p3.music.126.net/PLrMsE0bTG2p1lL6QfKC9g==/109951172414278510.jpg?param=300y300',
    musicSize: 195,
    albumSize: 40,
    tracks: const [],
  ),
  ArtistProfile(
    ...
    avatarUrl: 'https://p3.music.126.net/YSeeLcOZcHKaL42XcpLyPg==/109951170316912578.jpg?param=300y300',
    musicSize: 150,
    albumSize: 28,
    tracks: const [],
  ),
  ArtistProfile(
    ...
    avatarUrl: 'https://p3.music.126.net/FeO4YANsByG6S1j6nRMFyw==/109951162805384808.jpg?param=300y300',
    musicSize: 76,
    albumSize: 14,
    tracks: const [],
  ),
  ArtistProfile(
    ...
    avatarUrl: 'https://p4.music.126.net/36HG9EBu-LKlKl3BvqdeSg==/109951170514231799.jpg?param=300y300',
    musicSize: 185,
    albumSize: 34,
    tracks: const [],
  ),
  ArtistProfile(
    ...
    avatarUrl: 'https://p4.music.126.net/svHK8nEPa8J42tJ1by7jrw==/109951169875194361.jpg?param=300y300',
    musicSize: 110,
    albumSize: 20,
    tracks: const [],
  ),
